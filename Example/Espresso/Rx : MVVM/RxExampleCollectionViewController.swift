//
//  RxExampleCollectionViewController.swift
//  Espresso_Example
//
...
class RxExampleCollectionViewController: RxViewModelViewController<RxExampleViewModel> {
    ...
    override init(viewModel: RxExampleViewModel) {
        ...
        self.title = viewModel.collectionTitle
