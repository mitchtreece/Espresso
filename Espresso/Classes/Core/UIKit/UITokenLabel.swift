...
open class UITokenLabel: UIBaseView {
    ...
    /// The label's fill color. Also used as the border color; _defaults to black_.
    ...
    /// The label's border width; _defaults to 1_.
    public var borderWidth: CGFloat = 1
    
    /// The label's corner radius. If no value is specified, _(height / 2)_ will be used.
    public var cornerRadius: CGFloat?
    
    /// The label's background blur style.
    ///
    /// This overrides the `isFilled` property if set.
    ...
    //// The label's font; _defaults to system(12)_.
    ...
    /// The label's text color; _defaults to black_.
    ...
    /// The label's text insets; _defaults to (top: 3, left: 6, bottom: 3, right: 6)_.
    public var textInsets = UIEdgeInsets(top: 3, left: 6, bottom: 3, right: 6) {
        didSet {
            updateTextInsets()
        }
    }
