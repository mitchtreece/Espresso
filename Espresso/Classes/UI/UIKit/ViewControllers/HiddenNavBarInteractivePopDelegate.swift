//
//  HiddenNavBarInteractivePopDelegate.swift
//  Espresso
//
...
internal final class HiddenNavBarInteractivePopDelegate: NSObject, UIGestureRecognizerDelegate {

    weak var navigationController: UINavigationController?
    weak var originalGestureDelegate: UIGestureRecognizerDelegate?

    var isSwipeBackGestureEnabled: Bool = true
    ...
    func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer,
        ...
        if let nav = self.navigationController,
            ...
            if self.isSwipeBackGestureEnabled {
                return true
            }
