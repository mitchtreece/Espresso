//
//  UICombineCollectionViewCell.swift
//  Espresso
//
...
/// A Combine-based `UICollectionViewCell` subclass that provides
/// common properties & functions when backed by a view model.
open class UICombineCollectionViewCell<V: ViewModel>: UIViewModelCollectionViewCell<V> {
