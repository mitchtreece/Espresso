...
/// An extended `UITableViewCellEx` subclass that provides common
/// properties & functions when backed by a model.
open class UIModelTableViewCell<M: ViewModel>: UITableViewCellEx, ModelBinder {
