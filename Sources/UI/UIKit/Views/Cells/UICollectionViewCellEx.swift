...
/// An extended `UICollectionViewCell` subclass that provides
/// common helper functions & properties.
open class UICollectionViewCellEx: UICollectionViewCell, UIViewCommon, UIViewLifecycle, UIViewAppearance {
