...
/// Protocol describing the configurable properties
/// of a `UIHostingControllerExConfiguration`.
public protocol UIHostingControllerExConfigurable {
...
/// A `UIHostingControllerEx` configuration container.
public struct UIHostingControllerExConfiguration: UIHostingControllerExConfigurable {
...
/// `UIHostingControllerEx` configuration builder.
public typealias UIHostingControllerExBuilder = (inout UIHostingControllerExConfigurable)->()

/// An extended `UIHostingController` subclass
/// that provides common helper functions & properties.
///
/// @note
/// It's recommended to use `view.asHostingController()` or `view.asHostingControllerEx()`
/// as opposed to directly initializing via `UIHostingController(rootView:)` or
/// `UIHostingControllerEx(rootView:builder:)`. Using the helper `as` functions have
/// additional benefits like host-proxy injection.
///
/// @note
...
/// ```
open class UIHostingControllerEx<Content: View>: UIHostingController<Content>, UIViewControllerCommon, UIViewControllerLifecycle, UIViewControllerAppearance, UIKeyboardObserving {
    ...
    public var isSwipeBackGestureEnabled: Bool {
        get { return self.navigationControllerEx?.isSwipeBackGestureEnabled ?? false }
        set { self.navigationControllerEx?.isSwipeBackGestureEnabled = newValue }
    }
    ...
    public init(rootView: Content,
                builder: UIHostingControllerExBuilder?) {
 
        var config: UIHostingControllerExConfigurable = UIHostingControllerExConfiguration()
        builder?(&config)
